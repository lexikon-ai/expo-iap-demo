// ref: https://github.com/chromeos/pwa-play-billing/blob/0e5acbfb170285c5ff2b6c6831ce9bad28317e90/functions/src/billing.ts#L187
...
export class Purchase {
  ...
  toString(): string {
    return (
      // biome-ignore lint/style/useTemplate: to align with source
...
export class SubscriptionPurchase extends Purchase {
  ...
  latestNotificationType: NotificationType =
    NotificationType.SUBSCRIPTION_UNDEFINED; // Last RTDN notification
  externalAccountId = '';
